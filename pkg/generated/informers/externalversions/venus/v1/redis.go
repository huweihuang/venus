	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.VenusV1().Redises(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VenusV1().Redises(namespace).Watch(context.TODO(), options)
			},
		},
		&venusv1.Redis{},
		resyncPeriod,
...
func (f *redisInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&venusv1.Redis{}, f.defaultInformer)
}
