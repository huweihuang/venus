...
type Interface interface {
	// Memcaches returns a MemcacheInformer.
	Memcaches() MemcacheInformer
...
// Memcaches returns a MemcacheInformer.
func (v *version) Memcaches() MemcacheInformer {
	return &memcacheInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
